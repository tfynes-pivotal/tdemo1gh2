...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tfynes-pivotal&repo=tdemo1gh2",
  "projectName" : "tdemo1gh2",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tdemo1gh2]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tfynes-pivotal&repo=tdemo1gh2'
